...
var person1 = new Person("A", 10, "F", "M4B2K1", 3.50, sports3_ls, "img/D.jpg", "I'm some girl", 
	0, ls_teams, "hi@bye.com", "4152232211", ls_requests, 0, 120);

var person2 = new Person("B", 12, "F", "M1T2M5", 1000, sports3_ls, "img/D.jpg", "I'm some girl also", 
	1, ls_teams, "hello@bye.com", "1231231233",	ls_requests, 0, 60);

var person3 = new Person("C", 15, "M", "M4B2K1", 3.50, sports5_ls, "img/D.jpg", "nice guy", 
	0, ls_teams2, "C@bye.com", "4152232211", ls_requests, 0, 80);

var person4 = new Person("D", 16, "F", "M4B1B3", 3.50, sports5_ls, "img/D.jpg", "kool guy", 
	1, ls_teams2, "D@bye.com", "1111111111", ls_requests, 0, 90);

var person5 = new Person("E", 16, "M", "M1T2M5", 3.50, sports5_ls, "img/D.jpg", "dude guy", 
	0, ls_teams2, "E@bye.com", "2222222222", ls_requests, 0, 50);

var person6 = new Person("F", 18, "M", "M4B1B3", 3.50, sports5_ls, "img/D.jpg", "hi guy", 
	0, ls_teams3, "F@bye.com", "3333333333", ls_requests, 0, 180);
